...
class manajemen_datsis extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('V_manajemen_datsis', $data);
    ...
    function Tambah() {
        ...
        $this->load->view('Header', $data);
        $this->load->view('V_Tambah_datsis', $data);
        $this->load->view('Footer', $data);
    }
    ...
    function Baca($id) {
        ...
        $this->load->view('Header', $data);
        $this->load->view('V_Detail_datsis', $data);
        $this->load->view('Footer', $data);
    }
    ...
    function Ubah($id) {
        ...
        $this->load->view('Header', $data);
        $this->load->view('V_Ubah_datsis', $data);
        $this->load->view('Footer', $data);
    }
