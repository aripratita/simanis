...
?>
<form method="POST" action="<?= base_url('Sekolah/Data_Siswa/Update') ?>" method="POST" enctype="multipart/form-data">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label class="text-uppercase">No.Induk</label>
                    <input type="text" name="no_induk" class="form-control" value="<?php echo $u->no_induk ?>" readonly="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_kelamin" required="true" class="form-control" value="<?php echo $u->jenis_kelamin ?>">
                        <option value="0">
                            pilih jenis kelamin
                        </option>
                        <option value="1" <?php
                ...
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Tempat Lahir" autocomplete="off" name="tempat_lahir" value="<?php echo $u->tempat_lahir ?>" required="">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control datepicker" autocomplete="off" name="tanggal_lahir" placeholder="Tanggal lahir" value="<?php echo $u->tanggal_lahir ?>" required="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" autocomplete="off" name="nama_ibu" required="" value="<?php echo $u->nama_ibu ?>">
                </div>
                <div class="form-group">
                    <label class="text-uppercase">Alamat </label>
                    <textarea class="form-control" name="alamat_siswa" minlength="15"required=""><?php echo $u->alamat_siswa ?></textarea>
                </div>
                <div class="form-group">
